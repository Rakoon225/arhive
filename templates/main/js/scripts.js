$(function () {
  ...
  $(".promo-bg-carousel").slick({
    ...
    speed: 800,
    prevArrow:
      '<button class="prev" type="button"><svg><use href="/local/templates/main/img/icons/sprite.svg#left-arrow"></svg></button>',
    nextArrow:
      '<button class="next" type="button"><svg><use href="/local/templates/main/img/icons/sprite.svg#right-arrow"></svg></button>'
  });
  ...
  if (screenWidth < 1200) {
    $(".gallery__row:not(.slick-initialised)").slick({
      ...
      speed: 800,
      prevArrow:
        '<button class="prev" type="button"><svg><use href="/local/templates/main/img/icons/sprite.svg#arrow-left"></svg></button>',
      nextArrow:
        '<button class="next" type="button"><svg><use href="/local/templates/main/img/icons/sprite.svg#arrow-right"></svg></button>',
    });
  }
