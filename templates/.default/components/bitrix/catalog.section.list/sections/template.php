...
<div class="catalog">
 <div class="container">
	<div class="catalog__section">
              ...
              <!-- card--><a class="card card--lg" href="<?=$arObject['DETAIL_PAGE_URL'];?>">
                <div class="card__header">
                  <div class="card__img">
                    ...
                    <? if ($arObject['PROPS']['LIDER']['VALUE'] == 'Y'): ?>
                        <div class="card__hit">
                            <svg>
    	...
    	<? endif; ?>
        <div class="catalog__footer"><a class="catalog__btn" href="<?=$arSection['SECTION_PAGE_URL'];?>"><img src="<?=SITE_TEMPLATE_PATH;?>/img/icons/arrow-right-white-lg.png" alt=""><span>все ваши дома</span></a></div>
      </div>
<? endforeach; ?>